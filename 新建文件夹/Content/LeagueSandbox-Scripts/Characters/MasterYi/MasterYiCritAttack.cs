...
namespace Spells
{
    public class MasterYiCritAttack : ISpellScript
    {
        ...
        {
            // 技能预释放逻辑，例如添加粒子效果
            AddParticleTarget(owner, owner, "MasterYiCritAttack_Cast_Particle", owner);
        }
        ...
        public void ApplyEffects(ObjAIBase owner, AttackableUnit target, Spell spell, SpellMissile missile)
        {
            ...
            {
                // 计算暴击伤害
                var ad = owner.Stats.AttackDamage.Total * 2f;
                var damage = ad;
                ...
                // 添加粒子效果
                AddParticleTarget(owner, target, "MasterYiCritAttack_Hit_Particle", target);
            }

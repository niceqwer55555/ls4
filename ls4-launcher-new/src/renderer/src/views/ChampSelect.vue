<template>
    <div id="champselect">
        <div class="side ally">
            ...
            <div class="control">
                <AllyPlayer v-for="(player, index) in champselect.team" :key="index" :player="player" />
            </div>
            <div class="foot">
                <div class="lolblock">
                    <div class="head">
                    ...
                    <div class="inner">
                        <ChampionBan v-for="(ban, index) in allyBans" :key="index" :ban="ban" />
                    </div>
                </div>
            </div>
        </div>
        <div class="main">
            ...
            <div class="control">
                <div class="status">
                    <div class="leftArrow arrow" :class="{
                    ...
                    <div class="rightArrow arrow" :class="{
                ...
                <div class="champions">
                    <div class="head">
                        <div class="tabs">
                            <button :class="{ active: selectedTab == 'CHAMPIONS' }" @click="selectedTab = 'CHAMPIONS'">
                                {{ t("CS_TAB_CHAMPIONS") }}
                            </button>
                            <button :class="{ active: selectedTab == 'SKINS' }" :disabled="!currentPlayer.lockedIn"
                                @click="selectedTab = 'SKINS'">
                                {{ t("CS_TAB_SKINS") }}
                            </button>

                            <input type="text" class="actionInput" ref="actionInput"
                                :placeholder="t('CS_SEARCH_CHAMPION')" @keyup="typeAction" />
                        </div>
                        <div class="spacer"></div>
                    </div>
                    <div class="list" v-if="selectedTab == 'CHAMPIONS'">
                        <Champion v-for="(champion, index) in filteredChampions" :key="index" :champion="champion" />
                    </div>
                    <div class="list skins" v-else>
                        ...
                        <div id="carousel" :style="getCarouselStyle()">
                            <Skin :style="`--offset: ${index + 1};`" class="item" :class="{
                                toRight: index + 1 > skinCarouselPosition,
                                toLeft: index + 1 < skinCarouselPosition
                            }" v-for="(skin, index) in skins" :key="index" :skin="skin" />
                        </div>
                    </div>
                ...
                <div class="actions">
                    <div class="rmselect">
                        ...
                        <div class="selects">
                            <CustomSelect :options="['Runepage #1', 'Runepage #2', 'Runepage #3']"
                                :default="'Runepage #1'" class="select" @input="selectedRunePage" />
                            <CustomSelect :options="[
                                'Masterypage #1',
                                'Masterypage #2',
                                'Masterypage #3'
                            ]" :default="'Masterypage #1'" class="select" style="z-index: -1" @input="selectedMasteryPage" />
                        </div>
                    </div>
                    <div class="spellselect">
                        <div v-bind:class="{
                            aram: this.champselect.lobbyType == 'ARAM_BLIND'
                        }" class="spellmodal" ref="spellmodal">
                            <div class="spell" v-for="(spell, index) in filteredSpells" :key="index"
                    ...
                    <div class="lockin">
                        <button v-if="currentPlayer.canLockIn && !currentPlayer.lockedIn"
                            @mouseover="$sound.template('LOCKIN_HOVER')" @click="lockedInChampion">
                            {{ t("CS_ACTION_LOCK_IN") }}
                        </button>
                        <button class="banbtn" @mouseover="$sound.template('LOCKIN_HOVER')" @click="lockedInBan"
            ...
            <div class="foot">
                <div class="lolblock">
                    ...
                    <div class="inner">
                        ...
                        <div class="input">
                            <input type="text" v-on:keyup.enter="sendChatMessage" ref="chatInput"
        ...
        <div class="side enemy">
            ...
            <div class="control">
                <EnemyPlayer v-for="(player, index) in enemyTeam" :key="index" :player="player" :index="index" />
            </div>
            <div class="foot">
                <div class="lolblock">
                    <div class="head">
                    ...
                    <div class="inner">
                        <ChampionBan v-for="(ban, index) in enemyBans" :key="index" :ban="ban" />
                    </div>
                </div>
            </div>
        </div>

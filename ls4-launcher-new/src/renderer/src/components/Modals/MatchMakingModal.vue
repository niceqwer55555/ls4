    ...
    <div v-if="visible">
        ...
        <div class="modal" ref="modal" tabindex="-1">
            ...
            <div class="players" v-if="!canAct">
                <div class="player" v-for="index in matchFoundState.accepted" :key="index">
                    <img src="../assets/images/matchmaking_player_accept.png" />
                </div>
                <div class="player" v-for="index in matchFoundState.denied" :key="index">
                    <img src="../assets/images/matchmaking_player_deny.png" />
                </div>
                <div class="player pending" v-for="index in matchFoundState.pending" :key="index">
                    <img src="../assets/images/matchmaking_player_accept.png" />
                </div>
            </div>
        </div>
...
export default {
    ...
    beforeMount() {
        Modal.EventBus.$on("matchmaking-show", () => {
            this.show();
            window.electron.ipcRenderer.send("focusApp");
...
// from: https://codepen.io/KittyGiraudel/pen/BHEwo</style>
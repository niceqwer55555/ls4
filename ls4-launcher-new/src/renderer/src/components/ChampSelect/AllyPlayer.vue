<template>
    <div class="player">
        ...
        ">
            ...
            <div class="tradeinfo" v-if="tradeState.trade">
                <div class="trade initiator" v-if="tradeState.status == 'INITIATOR'">
                    <div class="champion">
                        <img :src="getChampionImgUrl(tradeState.trade.target.selectedChampion.id)
                            " />
                    </div>
                    <div class="exchange">
            ...
            <div class="actions">
                <div class="buttons" v-if="tradeState.status == 'TARGET'">
                    <button @click="acceptTrade(tradeState.trade.initiator.user.summonerName)">
                        {{ t("CS_TRADE_ACCEPT_BTN") }}
                    </button>
                    <button @click="denyTrade(tradeState.trade.initiator.user.summonerName)">
                        {{ t("CS_TRADE_DENY_BTN") }}
                    </button>
                </div>
                <span v-else>
        ...
        <button class="tradeButton" @click="initiateTrade" v-if="
        ...
        <div class="champion">
            <img :src="player.selectedChampion

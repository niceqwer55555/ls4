...
{
    static readonly Dictionary<int, LevelProp> Poros = new();
    static readonly Dictionary<int, LevelProp> LongChains = new();
    static readonly Dictionary<int, LevelProp> Chains = new();
    internal static void CreateProps()
    {
        ...
        LongChains.Add(0, AddLevelProp("LevelProp_HA_AP_Chains_Long", "HA_AP_Chains_Long", new Vector3(2883.2095f, 86.12982f, 5173.606f), new Vector3(0f, 324f, 0f), new Vector3(-88.8889f, 355.5555f, -100.0f), Vector3.One, type: 2));
        ...
        Poros.Add(4, AddLevelProp("LevelProp_HA_AP_Poro4", "HA_AP_Poro", new Vector3(10655.31f, -375.02237f, 8387.441f), new Vector3(0f, 222f, 0f), new Vector3(266.6666f, -55.5556f, -11.1111f), Vector3.One));
        LongChains.Add(2, AddLevelProp("LevelProp_HA_AP_Chains_Long2", "HA_AP_Chains_Long", new Vector3(5139.6133f, 97.240906f, 2801.751f), new Vector3(0f, 314f, 0f), new Vector3(155.5557f, 366.6666f, -322.2222f), Vector3.One, type: 2));
        ...
        Chains.Add(6, AddLevelProp("LevelProp_HA_AP_Chains6", "HA_AP_Chains", new Vector3(6074.8384f, 87.96773f, 3868.2524f), new Vector3(0f, 318f, 0.0f), new Vector3(-77.7778f, 222.2222f, -44.4445f), Vector3.One));
        Chains.Add(4, AddLevelProp("LevelProp_HA_AP_Chains4", "HA_AP_Chains", new Vector3(7492.48f, 76.85663f, 5250.153f), new Vector3(0f, 320f, 0.0f), new Vector3(-22.2222f, 211.1111f, 22.2223f), Vector3.One));
        ...
        Poros.Add(2, AddLevelProp("LevelProp_HA_AP_Poro2", "HA_AP_Poro", new Vector3(5644.625f, -732.70325f, 7807.1074f), new Vector3(0f, 34f, 0f), new Vector3(-88.8889f, 0f, 0f), Vector3.One));
        LongChains.Add(3, AddLevelProp("LevelProp_HA_AP_Chains_Long3", "HA_AP_Chains_Long", new Vector3(7724.4653f, 86.12982f, 9869.202f), new Vector3(0f, 314f, 0f), new Vector3(-33.3334f, 355.5555f, 166.6666f), Vector3.One, type: 2));
        ...
        Poros.Add(3, AddLevelProp("LevelProp_HA_AP_Poro3", "HA_AP_Poro", new Vector3(11036.813f, -732.7032f, 12432.2109f), new Vector3(0f, 166f, 0f), new Vector3(44.4445f, 0f, 0f), Vector3.One));
        LongChains.Add(1, AddLevelProp("LevelProp_HA_AP_Chains_Long1", "HA_AP_Chains_Long", new Vector3(9939.937f, 69.55461f, 7628.735f), new Vector3(0f, 320f, 0f), new Vector3(111.1112f, 300.0f, -111.1111f), Vector3.One, type: 2));
        Poros.Add(6, AddLevelProp("LevelProp_HA_AP_Poro6", "HA_AP_Poro", new Vector3(6753.814f, 48.33051f, 5412.7236f), new Vector3(0f, 130f, 0f), new Vector3(-22.2222f, -11.1111f, 0f), Vector3.One));
        ...
        Chains.Add(1, AddLevelProp("LevelProp_HA_AP_Chains1", "HA_AP_Chains", new Vector3(3931.2275f, 87.96773f, 6102.559f), new Vector3(0f, 314f, 0.0f), new Vector3(-22.2222f, 222.2222f, -66.6667f), Vector3.One));
        Poros.Add(0, AddLevelProp("LevelProp_HA_AP_Poro", "HA_AP_Poro", new Vector3(411.7452f, 751.8175f, 515.7069f), new Vector3(6f, 136f, 8f), new Vector3(-44.4445f, -11.1111f, -77.7778f), Vector3.One));
        ...
        Chains.Add(5, AddLevelProp("LevelProp_HA_AP_Chains5", "HA_AP_Chains", new Vector3(8959.606f, 87.96773f, 6577.5415f), new Vector3(0f, 316f, 0.0f), new Vector3(-33.3334f, 222.2222f, -77.7778f), Vector3.One));
        Poros.Add(5, AddLevelProp("LevelProp_HA_AP_Poro5", "HA_AP_Poro", new Vector3(12556.904f, -861.41876f, 9949.372f), new Vector3(0f, 182f, 0f), new Vector3(-288.8889f, -22.2222f, 244.4445f), Vector3.One));
        Chains.Add(3, AddLevelProp("LevelProp_HA_AP_Chains3", "HA_AP_Chains", new Vector3(6770.9233f, 65.74553f, 8888.638f), new Vector3(0f, 316f, 0.0f), new Vector3(-33.3334f, 200.0f, -33.3334f), Vector3.One));
        Chains.Add(2, AddLevelProp("LevelProp_HA_AP_Chains2", "HA_AP_Chains", new Vector3(5348.3027f, 76.85663f, 7505.369f), new Vector3(0f, 316f, 0.0f), new Vector3(11.1111f, 211.1111f, 0f), Vector3.One));
        Poros.Add(1, AddLevelProp("LevelProp_HA_AP_Poro1", "HA_AP_Poro", new Vector3(2141.1174f, -113.360855f, 4335.2715f), new Vector3(0f, 208f, 0f), new Vector3(-333.3333f, -55.5556f, 0f), Vector3.One));
    }

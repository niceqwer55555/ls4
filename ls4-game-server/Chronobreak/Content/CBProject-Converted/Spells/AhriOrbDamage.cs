namespace Buffs
{
    public class AhriOrbDamage : BuffScript
    {
        int orbofDeceptionIsActive;
        int[] effect0 = { 40, 65, 90, 115, 140 };
        public AhriOrbDamage(int orbofDeceptionIsActive = default)
        {
        ...
        public override void OnActivate()
        {
            ...
            if (orbofDeceptionIsActive == 1)
            {
                ...
                ApplyDamage(attacker, owner, effect0[level - 1], DamageType.DAMAGE_TYPE_MAGICAL, DamageSource.DAMAGE_SOURCE_SPELLAOE, 1, 0.325f, 0, false, false, attacker);

namespace Spells
{
    public class ShyvanaDoubleAttackHitDragon : SpellScript
    {
            ...
            ref HitResult hitResult)
        {
            ...
            AddBuff(attacker, target, new Buffs.ShyvanaDoubleAttackHitDragon(), 1, 1, 0.25f, BuffAddType.REPLACE_EXISTING, BuffType.INTERNAL, 0, true, false, false);
        }
    }
}
namespace Buffs
{
    public class ShyvanaDoubleAttackHitDragon : BuffScript
    {

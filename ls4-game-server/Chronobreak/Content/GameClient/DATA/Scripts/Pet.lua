...
function L0_1(A0_2, A1_2)
  ...
  if L2_2 == AI_TAUNTED or L2_2 == AI_FEARED then
    return
  end
...
function L0_1()
  ...
  if L0_2 == AI_PET_MOVE or L0_2 == AI_PET_HARDMOVE or L0_2 == AI_PET_HARDRETURN or L0_2 == AI_FEARED or L0_2 == AI_PET_HARDSTOP then
    return true
  end

...
function L0_1()
  ...
  if L0_2 == AI_PET_MOVE or L0_2 == AI_PET_HARDMOVE or L0_2 == AI_PET_HARDRETURN or L0_2 == AI_FEARED or L0_2 == AI_FLEEING or L0_2 == AI_PET_HARDSTOP then
    return true
  end
...
function L0_1()
  ...
  if L1_2 then
    ...
    if L1_2 > L2_2 then
      L1_2 = SetActorPositionFromObject
      L2_2 = me
      L3_2 = tempOwner
      L1_2(L2_2, L3_2)
      L1_2 = NetSetState
  ...
  if L0_2 ~= L1_2 then
    ...
    if L1_2 then
      L1_2 = distanceToOwner
      L2_2 = FAR_MOVEMENT_DISTANCE
      if L1_2 > L2_2 then
        L1_2 = distanceToOwner
        L2_2 = MINION_MAX_VISION_DISTANCE
        if L1_2 > L2_2 then
          L1_2 = SetLastPosPointWithObj
          L2_2 = tempOwner
          L1_2(L2_2)
          L1_2 = SetStateAndMoveInPos
          L2_2 = AI_PET_MOVE
          L1_2(L2_2)
        else
          L1_2 = SetStateAndCloseToTarget

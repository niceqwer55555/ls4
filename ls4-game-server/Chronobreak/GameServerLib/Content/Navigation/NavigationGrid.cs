...
namespace Chronobreak.GameServer.Content.Navigation
{
    public class NavigationGrid
    {
        ...
        /// <param name="translate">Whether or not the given coordinates are in CB form.</param>
        ...
        public bool IsAnythingBetween(GameObject a, GameObject b, bool checkVision = false)
        {
            ...
            //TODO: THIS IS A HORRIBLE BAND-AID FIX. THE SERVER CURRENTLY HAS ISSUES WITH BUSH BORDERS
            //FIND OUT WHY
            NavigationGridCell[] cellInRadius = GetAllCellsInRange(a.Position, 25).ToArray();
            if (cellInRadius.Any(x => x.HasFlag(NavigationGridCellFlags.HAS_GRASS)))
            {
